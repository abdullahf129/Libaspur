          ...
          <MDBCol col="4" md="6">
            ...
            <div className="d-flex justify-content-between mb-4">
              <MDBCheckbox
                ...
                label="Remember me"
              />
              <MDBBtn className="mb-0 px-5" size="lg" onClick={newregister}>
                Register Here{" "}
              </MDBBtn>
              <MDBBtn className="mb-0 px-5" size="lg" onClick={forgotpassword}>
                Forgot password{" "}
              </MDBBtn>
            </div>

            <div className="text-center text-md-start mt-4 pt-2">
              <MDBBtn className="mb-0 px-5" size="lg" onClick={handlelogincust}>
                Sign in{" "}
              </MDBBtn>
            </div>
