...
var a1 =
  "create table grp16_website.admin( admin_id varchar(200) Primary Key, password varchar(255))";
var i1 =
  "insert into grp16_website.admin values('abdullah','$2b$10$vyI6pWhW0NtWdvmfDLeIle3o.PiArrFMh/JHmUZk2tEr705fqibaG')";
var s1 =
  "create table grp16_website.product( product_id varchar(200) Primary Key, product_name varchar(255) not null, price varchar(255) not null, product_image varchar(255),category varchar(255),update_key int,active_bit int)";
var inven =
  "create table grp16_website.inventory( product_id varchar(200) Primary Key, quantity varchar(255), category varchar(255),update_key int,active_bit int)";
